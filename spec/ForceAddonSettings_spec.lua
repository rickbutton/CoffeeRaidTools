describe("ForceAddonSettings", function()
    ...
    describe("pre-profile NSRT (no NSRT.Profiles)", function()
        it("sets every ready-check sub-setting", function()
            ...
            assert.is_false(NSRT.ReadyCheckSettings.RaidBuffCheck)
            assert.is_false(NSRT.ReadyCheckSettings.SoulstoneCheck)
            assert.is_false(NSRT.ReadyCheckSettings.SourceOfMagicCheck)
